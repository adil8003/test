...
?>
<input type="hidden" id="shirtcatid" value="<?php echo $id; ?>" />
<div class="row">
    <div class="col-lg-4 col-md-5">
        <div class="card card-user"><br>
            <h5 class="title">Shirt Images 
                </h5><hr>
            <br>
            <br>
            <br>
    ...
    <div class="col-lg-8 col-md-7">
        <div  class="card">
            ...
            <div class="changePassword">
                <div class="content" >
                    <div class="header">
                        <h4 class="title">Edit product  <span>
                            ...
                            <div class="row" >
                                <div class="col-md-12">
                                    <div class="form-group" >
                                        ...
                                        <input type="text" value="<?php echo $objShirtcategories->title ?>" class="form-control border-input input-sm"  name="title" id="title" placeholder="  Title "
                                               required/>
                                    </div>
                                </div>
                            </div>
                            <div class="row" >
                                <div class="col-md-12">
                                    <div class="form-group" >
                                        ...
                                        <input type="text" readonly="readonly" value="<?php echo $objShirtcategories->offer ?>" class="form-control border-input input-sm" name="offer" id="offer" placeholder=" Offer "
                                               required/>
                                    </div>
                                </div>
                            </div>
                            <div class="row" >
                                <div class="col-md-12">
                                    <div class="form-group" >
                                        ...
                                        <input type="text" onblur="GetOfferPrice();" value="<?php echo $objShirtcategories->price ?>" class="form-control border-input input-sm"  name="price" id="price" placeholder=" Price "
                                               required/>
                                    </div>
                                </div>
                            </div>
                            <div class="row" >
                                <div class="col-md-12">
                                    <div class="form-group" >
                                        ...
                                        <input type="text" readonly="" value="<?php echo $objShirtcategories->offerprice ?>" class="form-control border-input input-sm"  name="offerprice" id="offerprice" placeholder=" Offer Price "
                                               required/>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <select class="form-control border-input input-sm" style=" padding: 7px 18px; height: 40px;" id="productstatusid" name="productstatusid" placeholder="- Select Customer Status -">
                                            ...
                                            foreach ($objProductstatus as $key => $value) {
                                                if ($value->id == $objShirtcategories->productstatusid) {
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <select class="form-control border-input input-sm" style=" padding: 7px 18px; height: 40px;" id="producttypeid" name="producttypeid" placeholder="- Select Customer Status -">
                                            ...
                                            foreach ($objProducttype as $key => $value) {
                                                if ($value->id == $objShirtcategories->producttypeid) {
                                                    echo "<option selected value='$value->id' >" . $value->name . "</option>";
                                                } else {
                                                    echo "<option value='$value->id' >" . $value->name . "</option>";
                                                }
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <select class="form-control border-input input-sm" style=" padding: 7px 18px; height: 40px;" id="statusid" name="statusid" placeholder="- Select Customer Status -">
                                            ...
                                            foreach ($objStatus as $key => $value) {
                                                if ($value->id == $objShirtcategories->statusid) {
                                                    echo "<option selected value='$value->id' >" . $value->name . "</option>";
                                                } else {
                                                    echo "<option value='$value->id' >" . $value->name . "</option>";
                                                }
...
<script src="js/dress/edit.js"></script>
