...
?>
<input type="hidden" id="trenddingid" value="<?php echo $id; ?>" />
                        ...
                        <div class="row" >
                            <div class="col-md-12">
                                <div class="form-group" >
                                    ...
                                    <input type="text" readonly="readonly" value="<?php echo $objTrendding->offer ?>" class="form-control border-input input-sm" name="offer" id="offer" placeholder=" Offer "
                                           required/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" >
                            <div class="col-md-12">
                                <div class="form-group" >
                                    ...
                                    <input type="file"  class="form-control border-input input-sm"  name="file" id="file" placeholder="  "
                                           required/>
                                </div>
                            </div>
                        </div>
                        <div class="text-center">
                            <button type="button" onclick="Savetrenddingproduct();" class="btn btn-info btn-fill btn-wd">Save Product</button>
                        </div>
...
<script src="js/trendding/add.js"></script>
<style>
    img {
    max-width: 100%;
    /*height: auto;*/
