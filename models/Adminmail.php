...
class adminMail {
    ...
    public function sendEmail($arrAdminmail) {
        $date = date('d/m/Y');
        $to = $arrAdminmail['toemail'];
        $subject = $arrAdminmail['subject'];
        $body = $this->getEmailHeader();
        $body .= $arrAdminmail['body'];
        $body .= $this->getEmailFooter();
        $header = 'MIME-Version: 1.0' . "\r\n";
        $header .= 'From:Kiwings <asauravsuman@gmail.com>' . "\r\n" .
                'Content-type: text/html' . "\r\n" .
                'Reply-To: asauravsuman@gmail.com' . "\r\n" .
                        ...
                        <div class='footer' >
                         <p  class= 'setPOne' style= 'font-size : 13.5px;color: #999;font-style: oblique;font-family: serif;'>
                            ...
                            <p class= 'setPFooter' style= 'font-size : 13.5px;color: #999;font-style: oblique;font-family: serif;'>
                                Keep <span>contact@kiwings.in</span> in your contacts. <a href= '" . $companyUrl . "' class= 'comName'>" . $companyName . "</a>
                            </p>
                        </div>
                        </div>
                    </body>
